                    ...
                    <section class="mb-3 prompt-screen row p-2">
                        <div class="col-lg-10 col-md-12">
                            <label for="prompt" class="form-label"> Prompt (Enter Product Name here)</label>
                            <textarea class="form-control" id="product-prompt" rows="4"
                        ...
                        <div class="col-lg-2 col-md-12">
                            ...
                            <button class="btn generate-btn col-12 mt-4 form-control" onclick="generateProductData()">
                                Generate Data
                            </button>
                        </div>
